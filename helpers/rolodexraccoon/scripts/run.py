...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Rolodex Raccoon")
    ...
    log_path = ROOT / "logs" / f"contacts-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Rolodex Raccoon — Task 2.2\n\n"
