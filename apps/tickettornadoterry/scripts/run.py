...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Ticket Tornado Terry")
    ...
    log_path = ROOT / "logs" / f"jira-csv-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Ticket Tornado Terry — Task 1.2\n\n"
