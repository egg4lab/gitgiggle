...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Audio Potluck Patty")
    ...
    log_path = ROOT / "logs" / f"audio-plan-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Audio Potluck Patty — Task 4.1\n\n"
