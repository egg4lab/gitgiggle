...
GitGiggle hosts personal giggler bots, static tools, and project demos:

- `gigglers/` for AI bots, automations, and publishable tools
- `apps/` and `helpers/` for legacy redirect stubs only (old GitHub Pages URLs)
