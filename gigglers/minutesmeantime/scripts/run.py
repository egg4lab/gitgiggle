...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Minutes Mean Time")
    ...
    log_path = ROOT / "logs" / f"minutes-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Minutes Mean Time — Task 4.2\n\n"
