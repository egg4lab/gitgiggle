# Minutes Mean Time — Task 4.2

Mean time between meetings, zero mean time to action items.
...
### 3. Run
```bash
python scripts/run.py --file standup-transcript.txt
```

Output lands in `logs/minutes-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 4.2 |
| **Input** | Meeting transcript + optional project notes / open JIRA items |
| **Output** | Executive minutes + machine-parseable action table |
