# Rolodex Raccoon — Task 2.2

Digs through trash — I mean threads — for CRM gold.
...
### 3. Run
```bash
python scripts/run.py --file communications-dump.txt
```

Output lands in `logs/contacts-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 2.2 |
| **Input** | Email threads, PDFs, research text, meeting notes |
| **Output** | JSON array or CSV contact records |
