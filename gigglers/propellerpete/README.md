# Propeller Pete of Taipei — Task 2.1

Taiwan corporate drone intel with extra propeller flair.
...
### 3. Run
```bash
python scripts/run.py --input "Focus: BVLOS compliance, seed: AeroVironment Taiwan partners"
```

Output lands in `logs/drone-brief-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 2.1 |
| **Input** | Optional seed companies, date range, regulatory vs enterprise focus |
| **Output** | Competitive analysis brief (Markdown) |
