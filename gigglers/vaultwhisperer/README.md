# Vault Whisperer Wendy — Task 3.1

Your Obsidian vault's gossip columnist — but professional.
...
### 3. Run
```bash
python scripts/run.py --file message-plus-vault-context.md
```

Output lands in `logs/draft-reply-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 3.1 |
| **Input** | Incoming message + Obsidian/context excerpts in `## CONTEXT` blocks |
| **Output** | Concise + detailed reply drafts |
