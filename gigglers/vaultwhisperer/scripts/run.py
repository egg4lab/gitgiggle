...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Vault Whisperer Wendy")
    ...
    log_path = ROOT / "logs" / f"draft-reply-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Vault Whisperer Wendy — Task 3.1\n\n"
