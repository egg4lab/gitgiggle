# Audio Potluck Patty — Task 4.1

Everyone brings a recording format; I bring the merge plan.
...
### 3. Run
```bash
python scripts/run.py --file recording-inventory.txt
```

Output lands in `logs/audio-plan-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 4.1 |
| **Input** | File manifest: paths, formats, durations, dates, sources |
| **Output** | STT prep plan + ordered file manifest |
