...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Mimey McMarkdown")
    ...
    log_path = ROOT / "logs" / f"parsed-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Mimey McMarkdown — Task 1.1\n\n"
