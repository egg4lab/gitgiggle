# Mimey McMarkdown — Task 1.1

Your email's MIME type is my love language.
...
### 3. Run
```bash
python scripts/run.py --file inbox-thread.pdf
```

Output lands in `logs/parsed-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 1.1 |
| **Input** | `.eml`, PDF text, or pasted email thread |
| **Output** | Structured Markdown + action items |
