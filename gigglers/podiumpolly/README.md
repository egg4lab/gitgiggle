# Podium Polly — Task 3.2

From bullet points to standing ovation — rhetorically speaking.
...
### 3. Run
```bash
python scripts/run.py --file keynote-notes.md
```

Output lands in `logs/speech-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 3.2 |
| **Input** | Thematic notes, audience, duration, speech vs slide deck |
| **Output** | Full script or slide-by-slide outline |
