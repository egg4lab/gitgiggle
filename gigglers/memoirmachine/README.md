# Memoir Machine Mark — Task 3.3

Class transcripts in, Pulitzer vibes out (no guarantees).
...
### 3. Run
```bash
python scripts/run.py --file class-transcripts.txt
```

Output lands in `logs/autobiography-YYYY-MM-DD.md`.
...
|-------|-------|
| **Task ID** | 3.3 |
| **Input** | One or more dated transcripts; optional chapter themes |
| **Output** | Chronological autobiographical narrative draft |
