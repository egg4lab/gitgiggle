...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Memoir Machine Mark")
    ...
    log_path = ROOT / "logs" / f"autobiography-{datetime.date.today().isoformat()}.md"
    log_path.parent.mkdir(parents=True, exist_ok=True)
    log_path.write_text(
        f"# Memoir Machine Mark — Task 3.3\n\n"
